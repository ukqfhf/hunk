...
/**
 * The authoring contract lives in `packages/hunk/src/extension-api/types.ts` and is re-exported
 ...
 *
 * `bundled` is Hunk's own compiled-in tier (`packages/hunk/src/extensions/default/`): no
