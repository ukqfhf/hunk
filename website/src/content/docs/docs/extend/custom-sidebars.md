...
| `actions`           | guarded navigation, clipboard, and notification actions the pane may trigger                                                                                              |
